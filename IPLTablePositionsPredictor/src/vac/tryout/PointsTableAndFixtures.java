...
public class PointsTableAndFixtures {
	...
	public int remainingNoOfMatches;
	...
	public PointsTableAndFixtures(int numberOfTeams, HashMap<String, PointsTableRow> pointsTable, 
		...
		this.remainingNoOfMatches = remainingNoOfMatches;
	...
	public PointsTableAndFixtures() {
		...
		pointsTable = new HashMap<String, PointsTableRow>(numberOfTeams);
		{
			...
			pointsTable.put("GL",	new PointsTableRow("GL",13,8,5,0,0,16,-0.479));
			...
			pointsTable.put("MI",	new PointsTableRow("MI",13,7,6,0,0,14,-0.082));
		...
		remainingNoOfMatches = 5;
		remainingMatches = new ArrayList<Pair<String, String>>(remainingNoOfMatches);
		...
		remainingMatches.add(new Pair<String, String>("GL", "MI"));
